...
import 'package:desk_sdui_demo/screens/hero.dart' show heroBinding;
import 'package:desk_sdui_demo/screens/chef.sdui_reg.g.dart' show registerChefDependencies;
import 'package:desk_sdui_demo/screens/hero.sdui_reg.g.dart' show registerHeroDependencies;
...
void registerAllScreens(Runtime rt) {
  ...
  rt.registerScreen(heroBinding);
  registerHeroDependencies(rt);
