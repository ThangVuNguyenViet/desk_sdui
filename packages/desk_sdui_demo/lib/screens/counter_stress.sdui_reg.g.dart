...
import 'package:desk_sdui_demo/screens/counter_stress.dart';
...
void registerCounter_stressDependencies(Runtime rt) {
  rt.registerWidget(
    'Stack',
    (args) => Stack(
      key: args['key'] as Key?,
  ...
  rt.registerConstant('Icons.circle', Icons.circle);
  rt.registerConstant('Colors.deepPurple', Colors.deepPurple);
